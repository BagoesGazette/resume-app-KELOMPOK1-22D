        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg beep"><i class="far fa-bell"></i></a>
            ...
            <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                {{-- 1. Ganti Nama Statis dengan Nama User --}}
                <div class="d-sm-none d-lg-inline-block">Hi, {{ auth()->user()->name }}</div></a>
                
                <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-title">Logged In</div>
                
                {{-- 2. Arahkan ke Halaman Edit Profile Breeze --}}
                <a href="{{ route('profile.edit') }}" class="dropdown-item has-icon">
                    <i class="far fa-user"></i> Profile
                </a>

                {{-- 
                    (Link "Activities" dan "Settings" ini masih statis. 
                    Kamu bisa hapus atau arahkan ke route yang benar jika sudah punya)
                --}}
                ...
                {{-- 3. Ganti Tombol Logout Agar Berfungsi --}}
                <a href="{{ route('logout') }}" class="dropdown-item has-icon text-danger"
                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <i class="fas fa-sign-out-alt"></i> Logout
                </a>

                {{-- 4. Tambahkan Form Logout (Wajib untuk Breeze) --}}
